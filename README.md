...
This is my vimrc, which is copied from https://github.com/amix/vimrc, where the vimrc of the author of "vim", Bram Moolenaar, is. I did some modification on his vimrc, according to my need. If you need Bram's vimrc, you can visit https://github.com/amix/vimrc. And Bram's homepage is http://amix.dk. Here, thanks, Bram.
